...
window.aid_prioritize = function(qualified_audiences) {
    ...
    var list = [
            ...
            {name: 'Existing Customer 2YVP Renewal 2P3P', audience_id: '333369', priority: 4},
            {name: 'My Shaw Pod Upsell', audience_id: '333357', priority: 5},
            {name: 'Existing Customer BlueCurve TV Launch', audience_id: '333358', priority: 6},
            {name: '3P Internet TV Phone Customers', audience_id: '333336', priority: 7},
            {name: '2P Internet Phone Customers', audience_id: '333335', priority: 8},
            {name: '2P TV Phone Customers', audience_id: '333334', priority: 9},
            {name: '2P Internet TV Customers', audience_id: '333333', priority: 10},
            {name: '1P Phone Customers', audience_id: '333332', priority: 11},
            {name: '1P Internet Customers', audience_id: '333331', priority: 12},
            {name: '1P TV Customers', audience_id: '333330', priority: 13},
            {name: 'SK East',audience_id: '111147',priority: 14},
            {name: 'Small Markets',audience_id: '111118',priority: 15},
            {name: 'Price Conscious 2P3P - Tier 2',audience_id: '111124',priority: 16},
            {name: 'Price Conscious 1P - Tier 2',audience_id: '111148',priority: 17},
            {name: 'Bundlers - Tier 2',audience_id: '111145',priority: 18},
            {name: 'Internet Lovers - Tier 2',audience_id: '111130',priority: 19},
            {name: 'Price Conscious 2P3P - Tier 1',audience_id: '111123',priority: 20},
            {name: 'Price Conscious 1P - Tier 1',audience_id: '111144',priority: 21},
            {name: 'Bundlers - Tier 1',audience_id: '111143',priority: 22},
            {name: 'Internet Lovers - Tier 1',audience_id: '111129',priority: 23},
            {name: '2P/3P Look-a-like',audience_id: '111117',priority: 24},
            {name: '1P Internet Look-a-like',audience_id: '111119',priority: 25},
            {name: 'Lower Mainland Edmonton',audience_id: '111150',priority: 26},
            {name: 'Exclusion - Existing Customer Signals and Current Employees',audience_id: '111110',priority: 27}
        ],
