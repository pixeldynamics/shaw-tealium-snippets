...
window.aid_prioritize = function(qualified_audiences) {
  ...
  var list = [
          ...
          {name: '333380_Existing Customer Targeted Upsell', audience_id: '333380', priority: 8},
          {name: 'My Shaw Pod Upsell', audience_id: '333357', priority: 9},
          {name: 'Existing Customer BlueCurve TV Launch', audience_id: '333359', priority: 10},
          {name: 'Existing Customer BlueCurve TV Launch', audience_id: '333358', priority: 11},
          {name: '3P Internet TV Phone Customers', audience_id: '333336', priority: 12},
          {name: '2P Internet Phone Customers', audience_id: '333335', priority: 13},
          {name: '2P TV Phone Customers', audience_id: '333334', priority: 14},
          {name: '2P Internet TV Customers', audience_id: '333333', priority: 15},
          {name: '1P Phone Customers', audience_id: '333332', priority: 16},
          {name: '1P Internet Customers', audience_id: '333331', priority: 17},
          {name: '1P TV Customers', audience_id: '333330', priority: 18},
          {name: 'Winback Promotion',audience_id: '111151', priority: 19},
          {name: 'SK East',audience_id: '111147',priority: 20},
          {name: 'Small Markets',audience_id: '111118',priority: 21},
          {name: 'Price Conscious 2P3P - Tier 2',audience_id: '111124',priority: 22},
          {name: 'Price Conscious 1P - Tier 2',audience_id: '111148',priority: 23},
          {name: 'Bundlers - Tier 2',audience_id: '111145',priority: 24},
          {name: 'Internet Lovers - Tier 2',audience_id: '111130',priority: 25},
          {name: 'Price Conscious 2P3P - Tier 1',audience_id: '111123',priority: 26},
          {name: 'Price Conscious 1P - Tier 1',audience_id: '111144',priority: 27},
