...
/*list*/
    var list = [
      ...
      {name: 'Internet Upsell', audience_id: '333337', priority: 9},
      {name: '3P Internet TV Phone Customers', audience_id: '333336', priority: 10},
      {name: '2P Internet Phone Customers', audience_id: '333335', priority: 11},
      {name: '2P TV Phone Customers', audience_id: '333334', priority: 12},
      {name: '2P Internet TV Customers', audience_id: '333333', priority: 13},
      {name: '1P Phone Customers', audience_id: '333332', priority: 14},
      {name: '1P Internet Customers', audience_id: '333331', priority: 15},
      {name: '1P TV Customers', audience_id: '333330', priority: 16},
      {name: 'SK East',audience_id: '111147',priority: 17},
      {name: 'Student - New',audience_id: '111146',priority: 18},
      {name: 'Small Markets',audience_id: '111118',priority: 19},
      {name: 'Price Conscious 2P3P - Tier 2',audience_id: '111124',priority: 20},
      {name: 'Price Conscious 1P - Tier 2',audience_id: '111148',priority: 21},
      {name: 'Bundlers - Tier 2',audience_id: '111145',priority: 22},
      {name: 'Internet Lovers - Tier 2',audience_id: '111130',priority: 23},
      {name: 'Price Conscious 2P3P - Tier 1',audience_id: '111123',priority: 24},
      {name: 'Price Conscious 1P - Tier 1',audience_id: '111144',priority: 25},
