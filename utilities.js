...
window.aid_prioritize = function(qualified_audiences) {
  ...
  var list = [
	  ...
	  {name: '333349_2YVP Renewal Framework Segment 1B', audience_id: '333349', priority: 4},
          ...
          {name: 'Existing Customer 2YVP Renewal 2P3P', audience_id: '333370', priority: 8},
          {name: 'Existing Customer 2YVP Renewal 2P3P', audience_id: '333369', priority: 9},
          {name: '333376_2YVP Upsell Personalization 1', audience_id: '333376', priority: 10},
          {name: '333377_2YVP Upsell Personalization 2', audience_id: '333377', priority: 11},
          {name: '333380_Existing Customer Targeted Upsell', audience_id: '333380', priority: 12},
          {name: 'My Shaw Pod Upsell', audience_id: '333357', priority: 13},
          {name: 'Existing Customer BlueCurve TV Launch', audience_id: '333359', priority: 14},
          {name: 'Existing Customer BlueCurve TV Launch', audience_id: '333358', priority: 15},
          {name: '3P Internet TV Phone Customers', audience_id: '333336', priority: 16},
          {name: '2P Internet Phone Customers', audience_id: '333335', priority: 17},
          {name: '2P TV Phone Customers', audience_id: '333334', priority: 18},
          {name: '2P Internet TV Customers', audience_id: '333333', priority: 19},
          {name: '1P Phone Customers', audience_id: '333332', priority: 20},
          {name: '1P Internet Customers', audience_id: '333331', priority: 21},
          {name: '1P TV Customers', audience_id: '333330', priority: 22},
          {name: 'Winback Promotion',audience_id: '111151', priority: 23},
          {name: 'SK East',audience_id: '111147',priority: 24},
          {name: 'Small Markets',audience_id: '111118',priority: 25},
          {name: 'Price Conscious 2P3P - Tier 2',audience_id: '111124',priority: 26},
          {name: 'Price Conscious 1P - Tier 2',audience_id: '111148',priority: 27},
          {name: 'Bundlers - Tier 2',audience_id: '111145',priority: 28},
          {name: 'Internet Lovers - Tier 2',audience_id: '111130',priority: 29},
          {name: 'Price Conscious 2P3P - Tier 1',audience_id: '111123',priority: 30},
          {name: 'Price Conscious 1P - Tier 1',audience_id: '111144',priority: 31},
          {name: 'Bundlers - Tier 1',audience_id: '111143',priority: 32},
          {name: 'Internet Lovers - Tier 1',audience_id: '111129',priority: 33},
          {name: 'Lower Mainland Edmonton',audience_id: '111150',priority: 34},
          {name: 'Exclusion - Existing Customer Signals and Current Employees',audience_id: '111110',priority: 35},
          {name: 'Business_SmartSurveillance & SmartSecurity',audience_id: '222234',priority: 36},
          {name: 'Business_SmartWiFi Audience',audience_id: '222228',priority: 37},
          {name: 'Business_SmartVoice Audience',audience_id: '222229',priority: 38},
          {name: 'Business_SmartWiFI & SmartVoice Audience',audience_id: '222230',priority: 39},
          {name: 'Business_Internet Audience',audience_id: '222231',priority: 40},
          {name: 'Business_Phone Audience',audience_id: '222232',priority: 41},
          {name: 'Business_Internet &Phone Audience',audience_id: '222233',priority: 42},
          {name: 'Business_General Remarketing',audience_id: '222227',priority: 43},
      ],
