...
window.aid_prioritize = function(qualified_audiences) {
  if (
    ...
    typeof utag_data.audience_id !== "undefined" &&
    utag_data.audience_id !== ""
  ) {
    qualified_audiences.push(utag_data.audience_id);
  } else if (
    typeof b !== "undefined" &&
    typeof b.audience_id !== "undefined" &&
    b.audience_id !== ""
  ) {
  ...
  var list = [
      {
        name: "Existing Customer 2YVP Renewal",
        audience_id: "333352",
        priority: 1
      },
      {
      ...
      {
        name: "Existing Customer 2YVP Renewal 2P3P",
        audience_id: "333370",
        priority: 4
      },
      {
      ...
      {
        name: "333376_2YVP Upsell Personalization 1",
        audience_id: "333376",
        priority: 6
      },
      {
        name: "333377_2YVP Upsell Personalization 2",
        audience_id: "333377",
        priority: 7
      },
      {
        name: "333374_Amazon Upsell_1P MTM Customers",
        audience_id: "333374",
        priority: 8
      },
      {
        name: "333375_Amazon Upsell_1P 2YVP Customers",
        audience_id: "333375",
        priority: 9
      },
      { name: "My Shaw Pod Upsell", audience_id: "333357", priority: 10 },
      {
        name: "Existing Customer BlueCurve TV Launch",
        audience_id: "333359",
        priority: 11
      },
      {
      ...
      {
        name: "3P Internet TV Phone Customers",
        audience_id: "333336",
        priority: 13
      },
      {
        name: "2P Internet Phone Customers",
        audience_id: "333335",
        priority: 14
      },
      { name: "2P TV Phone Customers", audience_id: "333334", priority: 15 },
      { name: "2P Internet TV Customers", audience_id: "333333", priority: 16 },
      { name: "1P Phone Customers", audience_id: "333332", priority: 17 },
      { name: "1P Internet Customers", audience_id: "333331", priority: 18 },
      { name: "1P TV Customers", audience_id: "333330", priority: 19 },
      { name: "Winback Promotion", audience_id: "111151", priority: 20 },
      { name: "SK East", audience_id: "111147", priority: 21 },
      { name: "Small Markets", audience_id: "111118", priority: 22 },
      {
        name: "Price Conscious 2P3P - Tier 2",
        audience_id: "111124",
        priority: 23
      },
      {
        name: "Price Conscious 1P - Tier 2",
        audience_id: "111148",
        priority: 24
      },
      { name: "Bundlers - Tier 2", audience_id: "111145", priority: 25 },
      { name: "Internet Lovers - Tier 2", audience_id: "111130", priority: 26 },
      {
        name: "Price Conscious 2P3P - Tier 1",
        audience_id: "111123",
        priority: 27
      },
      {
        name: "Price Conscious 1P - Tier 1",
        audience_id: "111144",
        priority: 28
      },
      { name: "Bundlers - Tier 1", audience_id: "111143", priority: 29 },
      { name: "Internet Lovers - Tier 1", audience_id: "111129", priority: 30 },
      { name: "2P/3P Look-a-like", audience_id: "111117", priority: 31 },
      { name: "1P Internet Look-a-like", audience_id: "111119", priority: 32 },
      { name: "Lower Mainland Edmonton", audience_id: "111150", priority: 33 },
      {
        name: "Exclusion - Existing Customer Signals and Current Employees",
        audience_id: "111110",
        priority: 34
      },
      {
        name: "Business_SmartSurveillance & SmartSecurity",
        audience_id: "222234",
        priority: 35
      },
      {
        name: "Business_SmartWiFi Audience",
        audience_id: "222228",
        priority: 36
      },
      {
        name: "Business_SmartVoice Audience",
        audience_id: "222229",
        priority: 37
      },
      {
        name: "Business_SmartWiFI & SmartVoice Audience",
        audience_id: "222230",
        priority: 38
      },
      {
        name: "Business_Internet Audience",
        audience_id: "222231",
        priority: 39
      },
      { name: "Business_Phone Audience", audience_id: "222232", priority: 40 },
      {
        name: "Business_Internet &Phone Audience",
        audience_id: "222233",
        priority: 41
      },
      {
        name: "Business_General Remarketing",
        audience_id: "222227",
        priority: 42
      }
    ],
    ...
    audience_match = list.filter(function(obj) {
      return (
        qualified_audiences.indexOf(obj.name) > -1 ||
        qualified_audiences.indexOf(obj.audience_id) > -1
      );
    }),
    sorted_audience = audience_match.sort(function(a, b) {
  ...
  if (
    typeof sorted_audience != "undefined" &&
    typeof sorted_audience[0] != "undefined" &&
    typeof sorted_audience[0].audience_id != "undefined"
  ) {
  ...
  if (typeof optimizely !== "undefined") {
    ...
    if (redirect === null) {
      Object.keys(optly).forEach(function(i, v) {
        exp.push(
          pid + "." + optly[i].experiment.id + "." + optly[i].variation.id
        );
...
(function(e, f) {
  ...
  e.fn.waitUntilExists = function(a, h, j) {
    ...
    "remove" === a
      ? g(c)
      : (k.each(a).data("waitUntilExists.found", !0),
        h && d.length
          ? g(c)
          : j ||
            (b[c] = f.setInterval(function() {
...
window.clickTrackEvent = function(el) {
  ...
  if ($this.closest("a.accordion-toggle").length) {
    var valueOfTab = String(
      $this.closest("a.accordion-toggle").attr("aria-expanded")
    );
  ...
  for (var n = 0; n < enArr.length; n++) {
    ...
    if (newName.includes("Action")) {
      ...
      if (newName.includes("optlyAction")) {
        trackObj["audience_id_v107"] =
          utag_data["audience_id"] || b["audience_id"];
        utag_data["audience_id_v107"] =
          utag_data["audience_id"] || b["audience_id"];
      }
    }
  }
...
function order_total() {
  var total = 0,
    sale_price = utag_data.product_sale_price || [];
  sale_price.forEach(function(value) {
    total += Number(value);
  });
  return total;
}
...
function rgu_count() {
  var total = 0,
    rgus = utag_data.product_rgu || [];
  rgus.forEach(function(value) {
...
// url toggle
if (
  window.location.href.indexOf("tshaw=off") > -1 ||
  location.search.indexOf("tshaw=off") > -1
) {
